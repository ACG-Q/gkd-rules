        ...
        rules: [
          {
            ...
            exampleUrls: 'https://m.gkd.li/47310744/590e8d61-57bf-405a-8700-8e88abce0945',
        ...
        rules: [
          {
            ...
            matches: '[text="跳过"]',
            exampleUrls: 'https://m.gkd.li/47310744/47fd901c-3331-4578-af34-cdef96f5f96d',
        ...
        rules: [
          {
            ...
            matches: '[text="关闭广告"]',
            exampleUrls: 'https://m.gkd.li/47310744/8567e244-9974-4959-9b67-0627379fd1ff',
          },
        ],
      },
      {
        ...
        rules: [
          {
            ...
            exampleUrls: 'https://m.gkd.li/47310744/aa2623d7-2555-4340-a3b3-bbbd37d09238',
          },
        ],
      }
    ],
